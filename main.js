...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const load0 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/Budapest.MP4');
  ...
  const load1 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/Matthias church.MP4');
  ...
  const load2 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/Pincehely 2.MP4');
  ...
  const load3 = async () => {
    ...
    const videoSet = await makeVideoPlane1('assets/videos/Pincehely.MP4');
